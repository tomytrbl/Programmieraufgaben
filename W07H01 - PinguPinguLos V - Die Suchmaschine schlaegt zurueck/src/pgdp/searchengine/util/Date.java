...
public class Date {
    ...
    /** Berechnet die Anzahl an Jahren zwischen diesem Date-Objekt und dem übergebenen.
     *  Dabei zählen nur ganze Jahre. Wenn das übergebene Date-Objekt ein Datum vor dem
     *  diesigen beschreibt, wird eine negative Anzahl an Jahren zurückgegeben.
     *
     *  Beispiele:  20.06.2010 bis 14.05.2015 --> 4 Jahre (da am 14.05. das fünfte Jahr noch nicht voll ist)
     *              07.07.2021 bis 04.03.2020 --> -2 Jahre (da hier ab dem 06.07.2021 rückwärts in die negativen gezählt wird)
     *
     * @param other Das Date-Objekt, zu dem der Abstand berechnet werden soll.
     * @return Der Abstand zwischen 'this' und 'other' in Jahren (immer zur nächstkleineren Zahl abgerundet).
     */
    ...
    /** Berechnet die Anzahl an Tagen zwischen diesem Date-Objekt und dem übergebenen.
     *  Dabei wird der durch 'this' beschriebene Tag aus- und der durch 'other' beschriebene
     *  mit eingeschlossen.
     *
     * @param other Das Date-Objekt, zu dem der Abstand berechnet werden soll.
    ...
    // Tag, an dem 'millis' Millisekunden nach Tagesbeginn des 01. Januar 1970 verstrichen sind
